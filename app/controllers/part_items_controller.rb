class PartItemsController < ApplicationController
  ...
  private
    ...
    def part_params
      params.require(:part_item).permit(:aircraft_id, :category, :part, :serial_no, :installed_date, :manufacturing_date, :aircraft_installation_date, :last_inspection_date, :is_servicable)
    end
end
